...
namespace DungeonLibrary
{
    public sealed class Troll : Monster
    {
        ...
        //CTORS        
        public Troll(string name, int hitChance, int block, int maxLife, int minDamage, int maxDamage, string description, int dmgBuff) : base(name, hitChance, block, maxLife, minDamage, maxDamage, description)
            {
               DamageBuff = dmgBuff;
