...
namespace DungeonLibrary
{
    public sealed class Goblin : Monster
    {
        ...
        //CTORS        
        public Goblin(string name, int hitChance, int block, int maxLife, int minDamage, int maxDamage, string description, int hitBuff) : base(name, hitChance, block, maxLife, minDamage, maxDamage, description)
        {
            HitBuff = hitBuff;
            HitChance += HitBuff;
